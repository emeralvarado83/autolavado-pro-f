    ...
    <footer id="contacto" className="bg-slate-900 text-slate-300 py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-400">
              El mejor cuidado para tu vehículo con productos de alta calidad y personal experto.
            </p>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center text-sm text-slate-500">
          <p>© {new Date().getFullYear()} AutoLavadoPro. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
